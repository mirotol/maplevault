    ...
    <>
      <div className="mb-8">
        <h2 className="text-2xl font-semibold mb-4 flex items-center gap-2">
          <LayoutGrid className="w-6 h-6 text-(--color-accent)" />
          Categories
        </h2>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        >
          <div className="w-16 h-16 mb-6 rounded-xl bg-(--color-accent-bg) flex items-center justify-center text-(--color-accent) group-hover:scale-110 transition-transform">
            <Ghost className="w-8 h-8" />
          </div>
          <h3 className="text-2xl font-bold mb-2 group-hover:text-(--color-accent) transition-colors">
            Monster List
          </h3>
